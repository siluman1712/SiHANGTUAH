        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    <li class="heading">REFERENSI</li>
                    <li>
                        <a href="/"><i class="sidebar-item-icon fa fa-home"></i>
                            <span class="nav-label">Halaman Utama</span>
                        </a>
                    </li>
                    <li>
                        <a href="/satker"><i class="sidebar-item-icon fa fa-building"></i>
                            <span class="nav-label">Satuan Kerja</span>
                        </a>
                    </li>
                    <li class="heading">DATA BASE</li>
                    <li>
                        <a href=""><i class="sidebar-item-icon fa fa-th-large"></i>
                            <span class="nav-label">BMN Unit Satker</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-bookmark"></i>
                            <span class="nav-label"></span><i class="fa fa-angle-left arrow"></i>UI</a>
