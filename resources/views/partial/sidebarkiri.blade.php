<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="header">
                <font color='#fff'>MENU TRANSAKSI</font>
            </li>
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="?module=penghapusan" title="penghapusan BMN">
                            <button class='btn bg-red btn-xs flat'>&nbsp;Proses Penghapusan BMN
                                &nbsp;&nbsp;&nbsp;</button>
                        </a>
                    </li>
                    ...
                    <li><a href="?module=dbr" title="DBR">
                            <button class='btn bg-orange btn-xs flat'>&nbsp;Insert Barang
                                Ruangan&nbsp;&nbsp;&nbsp;</button>
                        </a>
                    </li>

                    <li><a href="?module=updatedbr" title="DBR">
                            <button class='btn bg-orange btn-xs flat'>&nbsp;Update Barang
                                Ruangan&nbsp;&nbsp;&nbsp;</button>
                        </a>
                    </li>
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a href="?module=dbrumahnegara">
                            <button class='btn bg-olive btn-xs flat'>
                                <i class='fa fa-database text-white'></i>&nbsp;&nbsp;Database Rumah
                                Negara&nbsp;&nbsp;&nbsp;</button>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="?module=siprumahnegara">
                            <button class='btn bg-olive btn-xs flat'>
                                <i class='fa fa-plus text-white'></i>&nbsp;&nbsp;Daftarkan Rumah
                                Negara&nbsp;&nbsp;&nbsp;</button>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="?module=sipupdatestatus">
                            <button class='btn bg-blue btn-xs flat'>
                                <i class='fa fa-retweet text-white'></i>&nbsp;&nbsp;Update Status
                                SIP&nbsp;&nbsp;&nbsp;</button>
                        </a>
                    </li>
                </ul>
